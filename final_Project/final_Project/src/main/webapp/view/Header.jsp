    	...
    	<div class="container">
			...
			<form action="LoginServlet" method="post">
       		...
       		<form action="LogoutServlet" method="post">
       			<div class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
        		<ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        			<li><div class="form-control form-control-dark text-bg-dark">환영합니다, <%= id %>님</div></li>
        			<li><div style="padding:10px"></div></li>
       				<li><input type="submit" class="btn btn-secondary" value="로그아웃"></li>
       			</ul>
       			</div>
       		</form>
       		<% }
       		%>
       		<form action="signupView.jsp" method="post">
       			<div class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
